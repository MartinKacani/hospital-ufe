...
export interface WaitingListEntry {
    ...
    waitingSince: Date;
    /**
     * Estimated time of entering hospital. Ignored on post.
     * @type {Date}
     * @memberof WaitingListEntry
     */
    estimatedStart?: Date;
    /**
     * Estimated duration of hospital visit. If not provided then it will be computed based on condition and hospital settings
     * @type {number}
     * @memberof WaitingListEntry
     */
